    ...
    introduction: {
        ...
        description: (
            <div className='space-y-4'>
                <ContentParagraph>
                    একটা রান্নাঘরের কথা ভাবুন। সেখানে একজন রাঁধুনি আছেন,
                    যিনি নিজে থেকে কিছুই ভাবতে পারেন না। তাঁকে কাগজে লিখে দিতে
                    হয়: হাঁড়ি নিতে হবে, পানি ঢালতে হবে, চুলা জ্বালাতে হবে, দুই
                    মিনিট অপেক্ষা করতে হবে। রাঁধুনি কাগজ থেকে একটা লাইন পড়েন,
                    সেই কাজটা করেন, তারপর পরের লাইনে যান। এর বাইরে তিনি এক পা
                    এগোন না।
                </ContentParagraph>
                <ContentParagraph>
                ...
                <ContentParagraph>
                    এই রাঁধুনির নাম CPU। আজ আমরা দেখব এই CPU ঠিক কী কী করতে
                    পারে, কীভাবে করে, আর এত দ্রুত হয়েও কেন সে বেশিরভাগ সময়
                    বসে থাকে।
                </ContentParagraph>
            </div>
        ),
