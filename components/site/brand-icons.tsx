/**
 * Brand marks as inline SVG. This lucide build dropped its brand glyphs
 * (Github, Twitter), so the two we link to ship here instead. Both paint with
 * `currentColor` and take their size from `className`, like a lucide icon.
 */
